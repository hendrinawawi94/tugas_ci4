...
<div class="container">
    <h3>Data Siswa</h3>
    <button type="button" class="btn btn-primary mb-2" data-toggle="modal" data-target="#addModal">Tambah Siswa</button>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="#" class="btn btn-success  mr-2" data-toggle="modal"
                        data-target="#detailModal<?= $row->id;?>">Detail</a>
...
<form action="/SiswaController/update" method="post">
    <div class="modal fade" id="detailModal<?=$es->id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
...
<!-- Modal Edit Siswa-->
<form action="/SiswaController/update" method="post">
    <div class="modal fade" id="editModal<?=$es->id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Nama</label>
                        <input type="hidden" class="form-control" name="id" value="<?= $es->id; ?>"
                            placeholder="Masukkan Nama...">
                        <input type="text" class="form-control" name="nama" value="<?= $es->nama; ?>"
                            placeholder="Masukkan Nama...">
                    </div>

                    <div class="form-group">
                        <label>NIS</label>
                        <input type="text" class="form-control" name="nis" value="<?= $es->nis; ?>"
                            placeholder="Masukan NIS...">
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" class="form-control" name="email" value="<?= $es->email; ?>"
...
<form action="/SiswaController/delete" method="post">
    <div class="modal fade" id="deleteModal<?=$es->id?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
